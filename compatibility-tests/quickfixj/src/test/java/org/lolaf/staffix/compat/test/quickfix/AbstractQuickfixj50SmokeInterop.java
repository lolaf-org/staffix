...
import org.lolaf.staffix.fix50.encoders.EmailEncoder;
import org.lolaf.staffix.fix50.encoders.group.NoLinesOfTextEncoder;
import org.lolaf.staffix.fix50.fields.EmailThreadID;
import org.lolaf.staffix.fix50.fields.EmailType;
import org.lolaf.staffix.fix50.fields.Subject;
import org.lolaf.staffix.fix50.msg.MessageTypes;
...
/**
 * {@link AbstractQuickfixjSmokeInterop} over FIXT.1.1 carrying FIX 5.0.
 */
abstract class AbstractQuickfixj50SmokeInterop extends AbstractQuickfixjFixtSmokeInterop {

    @Override
    FixApplVerID applVerId() {
        return FixApplVerID.FIX50;
    }
