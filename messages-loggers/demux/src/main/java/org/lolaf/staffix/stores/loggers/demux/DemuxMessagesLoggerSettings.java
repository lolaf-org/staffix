...
/**
 * The loggers a demultiplexing logger feeds.
 */
@Getter
@SuperBuilder(toBuilder = true)
public class DemuxMessagesLoggerSettings extends AbstractFixMessageLoggerSettings {

    @Singular
    List<FixMessagesLogger> demuxedLoggers;
