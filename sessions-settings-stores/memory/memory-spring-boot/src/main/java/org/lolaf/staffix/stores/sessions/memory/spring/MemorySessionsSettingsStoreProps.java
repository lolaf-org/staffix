 ...
 */
@Data
@ConfigurationProperties(prefix = "staffix.sessions-settings-stores-memory")
public class MemorySessionsSettingsStoreProps {

    /**
     * The configured instances, keyed by the instance id a session names to select one.
     */
    private Map<String, MemoryStoreInstanceProps> instances = new LinkedHashMap<>();
