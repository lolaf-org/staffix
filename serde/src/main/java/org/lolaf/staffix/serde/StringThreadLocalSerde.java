...
public class StringThreadLocalSerde extends StringBaseSerde {
    ...
    private static final int MAX_CACHED_BYTE_ARRAY_FOR_STRING_SIZE = Integer.parseInt(System.getProperty("org.lolaf.staffix.serde.StringThreadLocalSerde.cached.bytes.array.max.size", "32"));
