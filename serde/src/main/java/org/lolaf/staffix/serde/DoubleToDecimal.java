...
import static org.lolaf.staffix.serde.MathUtils.*;
...
public class DoubleToDecimal {
    ...
    private static final int MAX_CACHED_BYTE_ARRAY_SIZE = Integer.parseInt(System.getProperty("org.lolaf.staffix.serde.DoubleToDecimal.cached.bytes.array.max.size", "64"));
    private static final int INITIAL_CACHED_BYTE_ARRAY_SIZE = Integer.parseInt(System.getProperty("org.lolaf.staffix.serde.DoubleToDecimal.cached.bytes.array.initial.size", "32"));
