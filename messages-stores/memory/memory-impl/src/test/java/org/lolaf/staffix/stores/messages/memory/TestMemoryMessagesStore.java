...
/**
 * Test class for {@link MemoryMessagesStore} using the generic test kit.
 */
class TestMemoryMessagesStore extends AbstractMessagesStoreTest {

    @Override
    protected FixMessagesStore createStore() {
        return new MemoryMessagesStore(MemoryMessageStoreSettings.builder()
