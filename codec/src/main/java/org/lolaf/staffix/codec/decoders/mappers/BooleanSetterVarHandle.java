...
class BooleanSetterVarHandle extends VarHandleSetterBase {

    private final boolean resetValue;

    BooleanSetterVarHandle(FixField field, VarHandle varHandle, Supplier<Object> varHandleTargetSupplier, boolean resetValue, boolean fieldAutoResetEnabled) {
