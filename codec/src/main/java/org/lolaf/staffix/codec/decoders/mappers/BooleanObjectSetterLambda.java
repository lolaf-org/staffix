...
class BooleanObjectSetterLambda extends SetterBase {

    private final Consumer<Boolean> consumer;
    private final Boolean resetValue;

    BooleanObjectSetterLambda(FixField field, Consumer<Boolean> consumer, Boolean resetValue, boolean fieldAutoResetEnabled) {
