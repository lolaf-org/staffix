...
class CharSetterVarHandle extends VarHandleSetterBase {

    private final char resetValue;

    CharSetterVarHandle(FixField field, VarHandle varHandle, Supplier<Object> varHandleTargetSupplier, char resetValue, boolean fieldAutoResetEnabled) {
    ...
    public void accept(SerDe.DeserializationContext ctx) {
        varHandle.set(varHandleTargetSupplier.get(), CharSerde.deserialize(ctx));
    }
