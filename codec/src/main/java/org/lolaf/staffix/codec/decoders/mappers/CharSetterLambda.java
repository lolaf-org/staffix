...
class CharSetterLambda extends SetterBase {

    private final FixFieldsDecoderMapper.CharConsumer consumer;
    private final char resetValue;

    CharSetterLambda(FixField field, FixFieldsDecoderMapper.CharConsumer consumer, char resetValue, boolean fieldAutoResetEnabled) {
    ...
    public void accept(SerDe.DeserializationContext ctx) {
        consumer.accept(CharSerde.deserialize(ctx));
    }
